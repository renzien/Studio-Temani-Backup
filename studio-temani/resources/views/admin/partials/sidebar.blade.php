            ...
            <ul class="menu">
                        ...
                        <li class="submenu-item has-sub">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item">
                                    <a href="/adminhome" class="submenu-link">Hero Post</a>
                                </li>

                                <li class="submenu-item">
                                    <a href="/adminabout" class="submenu-link">About Post</a>
                                </li>

                                <li class="submenu-item">
                                    <a href="/adminstudiopost" class="submenu-link">Studio Post</a>
                                </li>

                                <li class="submenu-item">
                                    <a href="/adminpricepost" class="submenu-link">Pricelist Info Post</a>
                                </li>

                                <li class="submenu-item">
                                    <a href="/admincontact" class="submenu-link">Contact Info Post</a>
                                </li>
                            </ul>
                        </li>

                        <li class="submenu-item has-sub">
                            <a href="#" class="submenu-link">Studio</a>
                            <ul class="submenu">
                                <li class="submenu-item">
                                ...
                                <li class="submenu-item">
                                    <a href="/adminequip" class="submenu-link">
                ...
                <li
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item">
                            <a href="/creativestudio" class="submenu-link">Creative Studio</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub {{ request()->is(['editaccount', 'configacc']) ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="/editaccount" class="submenu-link">Edit Profile</a>
                        </li>

                        <li class="submenu-item">
                            <a href="/configacc" class="submenu-link">Konfigurasi Akun</a>
                        </li>
                    </ul>
                </li>

                <li class="sidebar-item {{ request()->is('photo') ? 'active' : '' }}">
                    <a href="/photo" class="sidebar-link">
