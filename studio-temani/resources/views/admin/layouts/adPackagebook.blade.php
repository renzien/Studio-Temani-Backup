@extends('admin.packagebook')
@section('title', 'Package Booking Edit')
@section('bookpackageeditor')
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Posting Package Desc Post</h3>
                    <p class="text-subtitle text-muted">
                        List Postingan Untuk Yang Tertera pada postingan Package Desc Book
                    </p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-subtitle text-muted">Postingan Untuk Package Desc book</p>
                </div>
                <div class="card-body">
                    @if (session('success'))
                                            ...
                                            <div class="modal-dialog -scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('editPackageBook', $pb->id) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
